	...
	return (
		<div className={styles.ideas}>
			...
			<main>
				<h1>ideas</h1>
				<p>
					Hi! It is time to introduce ourselves!<br></br>We are an
					association that wants to make people aware of the importance of
					taking care of our planet and how much we threaten its health.
					<br></br>To encourage users to take action, we have partnered
					with large companies, as you can see in the Prize section. To
					learn more about us, click About.
				</p>
				<p>
					We are certain that activities we have proposed are great.
					<br></br>But we are also sure that you have great ideas too,
					share them here.
				...
				<div className={styles.paraWithImg}>
					<div className={styles.imagesPack}>
						<img
							src="../../../assets/images/page-ideas/tree-12.png"
							alt=""
						/>
						<img
							src="../../../assets/images/page-ideas/tree-11.png"
							alt=""
						/>
						<img
							src="../../../assets/images/page-ideas/bush.png"
							alt=""
						/>
					</div>
					<p>
						On behalf of plants, animals and the whole earth - THANK YOU!
					</p>
					<div className={styles.imagesPack}>
						<img
							src="../../../assets/images/page-ideas/rabbit.png"
							alt=""
						/>
						<img src="../../../assets/images/page-ideas/fox.png" alt="" />
						<img
							src="../../../assets/images/page-ideas/dolphin.png"
							alt=""
						/>
					</div>
				</div>
